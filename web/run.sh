...
$SUDO_WWW $CAKE Admin setSetting "Plugin.Import_services_url" "http://misp-modules"
...
$SUDO_WWW $CAKE Admin setSetting "Plugin.Export_services_url" "http://misp-modules"
